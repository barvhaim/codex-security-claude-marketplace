...
> Claude Code adaptation notice: this skill was adapted from OpenAI's Codex Security `track-findings` skill under Apache-2.0. Host-specific placeholders and namespaces were changed for Claude Code; see `${CLAUDE_PLUGIN_ROOT}/ADAPTATION.md` for compatibility limits.
